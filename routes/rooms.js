...
const { get, getById, getStays, getCurrentStay, putStay, add, update, del } = require('../controllers/rooms');
...
router.get('/:id/currentStay', isAuth, validator({ params: 'uuid' }), rbac('stays', 'read'), getCurrentStay);
